...
namespace RedLoader
{
    public class RLog
    {
        ...
        public class Instance
        {
            ...
            public void WriteSpacer() => RLog.WriteSpacer();
            public void WriteLine(int length = 30) => RLog.WriteLine(length);
            public void WriteLine(Color color, int length = 30) => RLog.WriteLine(color, length);

            public void BigError(string txt) => RLog.BigError(Name, txt);
        }
